...
Создадим файл  (рис. [-@fig:001]).

![создание](image/1.png){#fig:001}

Вставим строку  (рис. [-@fig:002]).

![Добавление строки](image/1.5.png){#fig:002}

Переместим строку и копируем строки через F6 и ctrl (рис. [-@fig:003]).

![Перемещение текста и Копирование текста](image/2.png){#fig:003}


Отменим действие через ctrl + u и вырежем строку (рис. [-@fig:004]).

![Отмена действия и удалим](image/3.png){#fig:004}


И откроем какой-нибудь исходный код, я взял код на с. Включим подцветку синтаксиса через ctrl + s (рис. [-@fig:005]).

![Включение подцветки синтаксиса](image/4.png){#fig:005}

К сожалению, подсветка не работает. (рис. [-@fig:006]).

![подсветка не работает](image/5.png){#fig:006}
