...
Теперь дозапишем в наш файл содержимое нашего домашнего каталога с помощью >> (рис. [-@fig:001]).

![Перенаправление в файл в режиме дозаписи](image/1.png){#fig:001}

Затем при помощи grep выведем содержимое нашего файла, куда мы записывали содержимое каталогов, таким образом, чтобы выводились только файлы с расширением conf (рис. [-@fig:002]).

![Использование grep](image/2.png){#fig:002}

Найдём в домашнем каталоге файлы, которые начинаются на "c" с помощью команды find (рис. [-@fig:003]).

![Использование find](image/3.png){#fig:003}

Теперь выведем постранично файлы, которые начинаются на "h", с помощью того же find. Для этого создадим конвеер, и передадим вывод в команду less (рис. [-@fig:004]).

![find и less](image/4.png){#fig:004}


Теперь запишем в файл имена файлов, начинающиеся с "log", но в фоновом режиме с помощью & (рис. [-@fig:005]).

![Запуск фоновой задачи](image/5.png){#fig:005}

Удалим этот файл (рис. [-@fig:006]).

![Удаление файла](image/5.png){#fig:006}

Запустим gedit в фоновом режиме (рис. [-@fig:007]).

![Запуск gedit в фоновом режиме](image/7.png){#fig:007}


Убьём процесс gedit по его pid (рис. [-@fig:008]).

![Завершение процесса](image/9.png){#fig:008}

Посмотрим на размер доступного места в системе с помощью df (рис. [-@fig:009]).

![Использование df](image/9.png){#fig:009}



Выведем все директории в домашнем каталоге с помощью find, указав в аргументе -type букву "d" (directory) (рис. [-@fig:010]).

![Использование find для вывода каталогов](image/10.png){#fig:010}
