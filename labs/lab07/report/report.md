...
Выполним первый раздел. Научимся копировать файлы с помощью команды cp. Создадим несколько файлов и поработаем с ними (рис. [-@fig:001]).

![Копирование файлов](image/1.png){#fig:001}

Теперь попробуем скопировать файлы в каталог /tmp (рис. [-@fig:002]).

![Копирование файлов в каталог tmp](image/2.png){#fig:002}

Перейдем ко второму этапу и воспользуемся командой  mv(рис. [-@fig:003]).

![Перемещение](image/3.png){#fig:003}

Разберёмся с правами доступа. Изменение прав осуществляется с помощью сhmod. Мы можем как давать права, так и отнимать (рис. [-@fig:004]).

![Права доступа](image/4.png){#fig:004}

Приступим к следующему этапу(рис. [-@fig:005]).

![Следующий этап](image/5.png){#fig:005}

Создаем несколько каталогов и перемещаем один в другой,лишая и наделяя их правами(рис. [-@fig:006]).

![Следующий этап](image/6.png){#fig:006}

Проверим /tmp/passwd (рис. [-@fig:007]).

![Проверим /tmp/passwd](image/7.png){#fig:007}

Создаем каталоги и файлы, неаделяем их правами а затем смотрим,значения тех или иных команд(рис. [-@fig:008]).


![Следующий этап](image/9.png){#fig:008}
