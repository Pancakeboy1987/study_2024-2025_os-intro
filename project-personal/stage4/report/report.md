...
Добавить информацию о соцсетях.
...
Добавим информацию о себе, о соцсетях рис. [-@fig:001])

![заполнение базовой информации о себе](image/1.png){#fig:001}

Напишем пост о том,что было [-@fig:002])

![пост о неделе](image/2.png){#fig:002}

напишем пост про презентации [-@fig:003])
