...
Добавим информацию о себе, о соцсетях рис. 

![заполнение базовой информации о себе](image/1.png)

## Выполнение лабораторной работы

Напишем пост о том,что было 

![пост о неделе](image/2.png)

## Выполнение лабораторной работы

напишем пост про презентации 

![пост про презентации](image/3.png)
